...
public class StringManipulation {
	...
	public static void main(String[] args) {
		...
		System.out.println("hmmmmm " + st1.codePointAt(1));
		System.out.println("hmmmmm " + st1.codePointBefore(3));
		System.out.println("hmmmmm " + st1.codePointCount(1, 2));
		System.out.println("hmmmmm " + st1.compareTo(str));
